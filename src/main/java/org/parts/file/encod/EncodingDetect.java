...
public class EncodingDetect {
	 ...
	 * @return
	 */
	public static String filePathEncode(String filePath) {
	 ...
	 * @return
	 */
	public static String fileStreamEncode(byte[] fileStream) {
		BytesEncodingDetect s = new BytesEncodingDetect();
		String fileCode = BytesEncodingDetect.javaname[s.detectEncoding(fileStream)];
		return fileCode;
	}
